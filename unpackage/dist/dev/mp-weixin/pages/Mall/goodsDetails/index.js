...
var _index = _interopRequireDefault(__webpack_require__(/*! ./pages/Mall/goodsDetails/index.vue */ 154));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
/* harmony import */ var _index_vue_vue_type_template_id_5f8bdfa7___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./index.vue?vue&type=template&id=5f8bdfa7& */ 155);
...
//
//
var Banner = function Banner() {return __webpack_require__.e(/*! import() | components/Banner */ "components/Banner").then(__webpack_require__.bind(null, /*! ../../../components/Banner.vue */ 478));};var _default = { components: { Banner: Banner }, data: function data() {return { IMG_URL: _index.IMG_URL, indicatorDots: false, autoplay: true, goods: {}, imgs: [], currentIndex: 0, rules: [{ title: "兑换规则", content: "用户凭积分兑换商品后将会从用户积分中扣除对应积分;" }, { title: "发货说明", content: "积分商城仅支持中国大陆地区（不含港澳台地图）的兑换邮寄服务，兑换成功后将于3-7个工作日邮寄积分商品。" }, { title: "售后服务", content: "积分商城在兑换后不可退换，请您在收货时确认物品完好再签收，若您收到的商品存在质量问题，请您及时拨打400-970-0989或联系在线客服，客服人员会为您核实处理的，请您放心。" }] };}, onLoad: function onLoad(option) {}, onShow: function onShow() {var _this = this;var goods = uni.getStorageSync('goods');this.goods = JSON.parse(goods || '{}');var imgs = JSON.parse(this.goods.img2 || '[]');this.imgs = imgs.reduce(function (a, b) {var obj = {};obj.imgUrl = _this.IMG_URL + b.value;a.push(obj);return a;}, []);
  },
  methods: {
