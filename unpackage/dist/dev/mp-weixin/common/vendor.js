...
var mutations = {
  SET_USERDETAIL: function SET_USERDETAIL(state, userDetail) {
...
var actions = {
  setUserDetail: function setUserDetail(_ref, userDetail) {var commit = _ref.commit;
    commit('SET_USERDETAIL', userDetail);
  },

  setUserInfo: function setUserInfo(_ref2, userInfo) {var commit = _ref2.commit;
    commit('SET_USERINFO', userInfo);
  },

  setLevel: function setLevel(_ref3, level) {var commit = _ref3.commit;
    commit('SET_LEVEL', level);
  } };


var getters = {
  userDetail: function userDetail(state) {return state.userDetail;},
  userInfo: function userInfo(state) {return state.userInfo;},
  level: function level(state) {return state.level;} };var _default =
...
"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.default = exports.getLevel = exports.goLoginPageTimeOut = exports.URL = exports.IMG_URL = void 0;var IMG_URL = 'https://heart-score-mall.oss-cn-hangzhou.aliyuncs.com/goods/';exports.IMG_URL = IMG_URL;

var URL = 'https://xiaohongxinheadpic.oss-cn-hangzhou.aliyuncs.com';exports.URL = URL;
...
var fetch = __webpack_require__(/*! ./config.js */ 38);
...
module.exports = {
  ...
  // 环保数据
  getEnvData: function getEnvData(userId) {
    return fetch({
