...
module.exports = {
  ...
  myDelivery: function myDelivery(data) {
    return fetch({
      url: '/recover-api/deliver/wechat/deliverDetails/' + data.id + '/' + data.page + '/' + 10 });

  },
  // 厨余垃圾投递记录
  myKwDelivery: function myKwDelivery(data) {
    return fetch({
  ...
  // 用户积分明细 分页
  scoreRecords: function scoreRecords(data) {
    return fetch({
  ...
  /** 家庭账户 */
  // 根据用户id获取家庭账户数据
  familyByUserId: function familyByUserId(userId) {
    return fetch({
  ...
  // 删除家庭成员
  delFamilyMember: function delFamilyMember(userId) {
    return fetch({
  ...
  // 用户绑定ic卡
  bindIcCard: function bindIcCard(data) {
    return fetch({
...
module.exports = {
  ...
  uploadOss: function uploadOss(path) {
    var token = uni.getStorageSync('token');
    return new Promise(function (resolve, reject) {
      uni.uploadFile({
  ...
  uploadVoice: function uploadVoice(path) {
    var token = uni.getStorageSync('token');
    return new Promise(function (resolve, reject) {
      uni.uploadFile({
  ...
  uploadFace: function uploadFace(data) {
    var token = uni.getStorageSync('token');
    // 重新上传 / 上传人脸
    var url = data.hasPhoto ? BASE_URL + '/user-api/user/updateFace/' + data.userId : BASE_URL + '/user-api/user/facePic/' + data.userId;
    return new Promise(function (resolve, reject) {
      uni.uploadFile({
        url: url,
        header: {
