			...
			<view v-for="item in list" :key="item.id" 
				...
				<view class="flex-ct-bwt" @click="fold(item)">
					<view class="flex-ct q">
						<image class="icon-l" src="/pages/About/images/qustion.png" mode=""></image>
						<view>{{item.question}}</view>
					</view>
					<view class="arrow"></view>
				</view>
				<view class="a" v-show="actives.includes(item.id)">
					<image class="icon-l" src="/pages/About/images/answer.png" mode=""></image>
				...
				tabs:[
					{
						id:1,
						title:"官方客服电话",
						bg:"/pages/About/images/back-left.png",
						icon:"/pages/About/images/phone.png",
						subTitle:"400-970-0989"
					},
					{
						title:"在线客服",
						bg:"/pages/About/images/back-right.png",
						icon:"/pages/About/images/helper.png",
