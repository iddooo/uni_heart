		...
		data(){
			return{
				grandTotal:[
					...
					{name:"我的积分",count:"0",url:"/pages/Score/score/index",need:true}
				],
				welfare:0,
				times:0,
				days:0,
				servers:[
					{name:"我的投递",image:"/static/mine/delivery.png",url:"/pages/Score/delivery/index",need:true},
					{name:"人脸识别",image:"/static/mine/face.png",url:"/pages/AI/face/index",need:true},
					{name:"环保金明细",image:"/static/mine/gold.png",url:"/pages/Score/gold/index",need:true},
